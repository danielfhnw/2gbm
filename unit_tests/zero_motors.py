...
if servo_position1 <= 2047:
    offset_servo1 = servo_position1
else:
    offset_servo1 = 2048 + 4096 - servo_position1

if servo_position2 <= 2047:
    offset_servo2 = servo_position2
else:
    offset_servo2 = 2048 + 4096 - servo_position2
